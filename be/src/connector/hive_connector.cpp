...
void HiveDataSource::_init_counter(RuntimeState* state) {
    ...
    _profile.cache_read_bytes = ADD_COUNTER(_runtime_profile, "CacheReadBytes", TUnit::UNIT);
    ...
    _profile.cache_write_bytes = ADD_COUNTER(_runtime_profile, "CacheWriteBytes", TUnit::UNIT);
