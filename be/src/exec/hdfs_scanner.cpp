...
void HdfsScanner::update_counter() {
    ...
    if (_scanner_params.use_block_cache && _cache_input_stream) {
        ...
        COUNTER_UPDATE(profile->block_cache_read_shared_buffer_counter, stats.read_shared_buffer_count);
        COUNTER_UPDATE(profile->block_cache_read_shared_buffer_bytes, stats.read_shared_buffer_bytes);
    }
