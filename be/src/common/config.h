...
CONF_String(data_cache_meta_path, "${STARROCKS_HOME}/data_cache/");
CONF_Int64(data_cache_block_size, "262144");   // 256K
CONF_Bool(data_cache_checksum_enable, "false");
// Maximum number of concurrent inserts we allow globally for block cache.
// 0 means unlimited.
CONF_Int64(data_cache_max_concurrent_inserts, "1500000");
